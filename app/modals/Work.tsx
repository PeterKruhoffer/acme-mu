...
function Work() {
  return (
    <View className='bg-white flex flex-1'>
      ...
      <View className='p-8'>
        <LabelAndDetail label='Arbejdsplads' title='Justitsministeriets Departement' />
        <LabelAndDetail label='Titel' title='Konsulent' />
        <LabelAndDetail label='Arbejdstid' title='Deltid (< 29,9)' />
        <LabelAndDetail label='Stillingskategori' title='Fuldmægtig, konsulent mv. (ikke leder)' />
